...
if __name__ == "__main__":
    BASE_DIR = rf"{ROOT}\Results\Transfer\yuhua_light"
    FILENAME = "2019-08-20_03_50.tif"
    SHP_PATH = rf"{ROOT}\Data\dataset\geo\yuhuo\watershedBoundary.shp"
    HILLSHADE_PATH = rf"{ROOT}\Data\dataset\geo\yuhuo\HillSha_yuhu.tif" 
