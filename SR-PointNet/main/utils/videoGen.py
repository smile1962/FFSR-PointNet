...
if __name__ == "__main__":
    dem_file = rf"{ROOT}\Data\dataset\geo\dem_30.tif"
    pred_dir = rf"{ROOT}\Results\FFSR-PointNet-Light\D_pred"
    true_dir = rf"{ROOT}\Results\FFSR-PointNet-Light\D_true"
    out_dir = rf"{ROOT}\Results\FFSR-PointNet-Light\comparison_frames_D"
    #
