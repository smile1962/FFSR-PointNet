...
# Sample file reference: 20-10.tif
...
# Load experiment configuration for Yuhuo study area
config = get_config()
...
# =========================================================
# Yuhuo Study Area TIF Georeference Parameters
# =========================================================
rows, cols = 445, 986
...
# Low-Resolution (LR) TIF Georeference Parameters
rows_LR, cols_LR = 33, 74
...
# =========================================================
# Dataset Path Configuration (Yuhuo Validation Set)
# =========================================================
...
for i, (inputs, targets, coords_low, coords_high) in enumerate(test_loader):
    ...
    # Optional: Threshold small values to 0 for cleaner visualization
    # Dg[Dg < 1.0] = 0.0
    # Dp[Dp < 1.0] = 0.0
    ...
    # Optional: Remove zero ground truth points (dry areas)
    ...
    # Bilinear interpolation baseline calculation for comparison
    ...
    truth_reshape = interpolate_lowres_to_highres_flat(
        Xp, Yp, Ug, grid_Xp_region, grid_Yp_region, grid_Xp_region, grid_Yp_region
        # visualize=False,
        # save_path="./",
        # dpi=600
    )

    # Uncomment to generate baseline correlation plots for comparison
